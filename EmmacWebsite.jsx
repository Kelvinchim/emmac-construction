  ...
  const services = [
    {
      ...
      text: "Modern commercial, institutional, and residential construction delivered with a strong focus on quality, safety, and execution."
    },
    {
      title: "Civil Works",
      text: "Roads, drainage, site preparation, structural works, and infrastructure support for public and private sector clients."
    },
    {
      title: "Project Delivery",
      text: "End-to-end coordination from planning to handover, with emphasis on timelines, compliance, and cost control."
    }
  ];
    ...
    <div className="min-h-screen bg-neutral-950 text-white font-sans">
      ...
      <header className="sticky top-0 z-50 border-b border-white/10 bg-neutral-950/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-10">
          ...
          <a href="#contact" className="rounded-2xl border border-white/15 px-4 py-2 text-sm font-medium transition hover:bg-white hover:text-black">
            Get in Touch
          </a>
        </div>
      </header>
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl gap-12 px-6 py-24 lg:grid-cols-[1.2fr_0.8fr] lg:px-10">
          <div>
            <div className="mb-6 inline-flex rounded-full border border-white/15 px-4 py-2 text-xs uppercase tracking-[0.3em] text-white/60">
              Civil & Building Contractors · Malawi
            </div>
            <h1 className="max-w-3xl text-5xl font-black leading-tight tracking-tight md:text-6xl lg:text-7xl">
              Building Malawi with precision, structure, and trust.
            </h1>
            <p className="mt-6 max-w-xl text-base leading-7 text-white/60 md:text-lg">
              EMMAC Construction delivers infrastructure, irrigation, and building projects across Malawi — on time, to spec, with accountability.
            </p>
            <div className="mt-8 flex flex-wrap gap-4">
              <a href="#projects" className="rounded-2xl bg-white px-6 py-3 text-sm font-semibold text-black transition hover:opacity-90">
                View Projects
              </a>
              <a href="#contact" className="rounded-2xl border border-white/20 px-6 py-3 text-sm font-semibold text-white transition hover:bg-white/5">
                Get in Touch
              </a>
            </div>
          </div>
              ...
              <div key={project.title} className="group overflow-hidden rounded-3xl border border-white/10 bg-neutral-900">
                <div className="relative h-64 overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-6">
                    <span className="rounded-full border border-white/20 bg-black/40 px-3 py-1 text-xs uppercase tracking-[0.2em] text-white/70 backdrop-blur">
                      {project.category}
                    </span>
                  </div>
                </div>
      ...
      <section id="clients" className="border-b border-white/10 bg-white/[0.02]">
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-10">
          ...
          <h2 className="mt-3 text-3xl font-bold tracking-tight md:text-4xl">
            Trusted by institutions that require reliability and scale.
          </h2>
